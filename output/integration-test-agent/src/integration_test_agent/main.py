...
from integration_test_agent.config import settings, get_model, get_memory, get_toolkit
...
async def main():
    ...
    # Start interaction
    print(f"🤖 integration-test-agent is ready! Type 'exit' to quit.")
    ...
    while True:
        try:
            ...
            print(f"\nintegration-test-agent: {response}")
